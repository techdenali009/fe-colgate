...
export const plpFilters = [
  ...
  },
  {
    ...
    title: 'Product Category',
    mainCatagory: 'Professional treatments',
    AccordionType: '',
    options: [
      ...
      { title: 'Oily', count: 18 },
      { title: 'Discoloration', count: 18 },
    ]
  },
  {
    title: 'Best Seller',
    mainCatagory: 'best-seller',
    AccordionType: AccordionType.Checkbox,
    options: [{ title: 'Best Seller', count: 1 }]
  },
  {
    title: 'Product Types',
    mainCatagory: 'product-types',
    AccordionType: AccordionType.Checkbox,
  ...
  {
    title: 'Skin Type',
    mainCatagory: 'skin-type',
    AccordionType: AccordionType.Checkbox,
    options: [{ title: 'Combination', count: 1 }, { title: 'Dry', count: 2 }, { title: 'Normal', count: 3 }, { title: 'Oily', count: 4 }, { title: 'Sensitive', count: 5 }]
  }
