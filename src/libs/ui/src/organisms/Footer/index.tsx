...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-black text-white ">
      <div className='px-6  lg:p-14 lg:!pb-0 lg:!pt-14 m-0 lg:mx-10'>
        {/* Desktop view */}
        ...
        <div className='hidden lg:flex gap-1 xl:flex  '>
          ...
          <LinkGroup links={OtherLinks} className="pr-1 !mb-0 flex  footer-item items-center pt-8 text-sm font-HeroNewLight" onClick={(pageName) => {
            navigate(pageName, 'otherLinks')
          }} />
        </div>

        <div className='hidden flex-col items-center py-8 text-brand-white-100 lg:flex-row logo-wrapper h-3  lg:flex xl:flex pb-14 pr-1'>
        ...
        <div className=''>
          ...
          <div className='lg:hidden sm:text-left py-8 md:px-4 '>
            <Image src={PCA_LOGO} alt={''} className=''></Image>
