...
const ProductDetailsContent: React.FC<ProductDetailsContentProps> = ({
  ...
  return (
    <div className='productdetailspage-container flex flex-col lg:flex-row w-full lg:w-full'>
      ...
      <div className='productdetailspage-info py-2.5 pl-[6rem] lg:w-full'>
        ...
        <div className='rating-icons-container flex mb-[20px]'>
          <div className='rating flex '>
            ...
            <a href='/' className='text-appTheme pl-2.5'>
              Write a Review
            </a>
          </div>
          {isLoggedIn ? (
        ...
        <div className='badges flex mb-6 mt-6'>
          <div className='badge1 pr-[25px]'>
            <h3 className='text-[#555555] font-hero font-bold text-[15px] mb-4 lg:mb-2'>
              Skin Types
            </h3>
            <div className='flex space-x-2'>
              <SkinTypeBadge active={true}>{bySkinConcern}</SkinTypeBadge>
            </div>
          </div>
          <div className='badge2'>
            ...
            <div className='flex space-x-2'>
              <SkinTypeBadge active={true}>{bySkinType}</SkinTypeBadge>
            </div>
          </div>
        </div>
