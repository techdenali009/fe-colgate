...
const ProductExcellence: React.FC = () => {
  return (
    <div className='flex flex-col items-center'>
      <div className="mb-6">
        <ProductImage src={'https://www.pcaskinpro.com/cms/assets/846329ca-d3ee-4e69-8e8c-3d558404b6aa.jpg?key=pca-en-us-marketing-header-large'} alt={'Peels'}></ProductImage>
      </div>
