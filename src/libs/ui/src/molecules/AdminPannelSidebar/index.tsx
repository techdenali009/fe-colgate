        ...
        <nav className='sidebar-nav p-4 font-HeroNewSemiBold'>
          <ul>
            <li className='p-2 flex justify-start  items-center'>
              ...
              <Link to='/home' className='text-black hover:underline pl-4'>
                Dashboard
              </Link>
            </li>
          </ul>
          <ul>
            <li className='p-2 flex justify-start items-center'>
              ...
              <Link to='/about' className='text-black hover:underline pl-4'>
                User Management
              </Link>
            </li>
          </ul>
          <ul>
            <li className='p-2 flex justify-start items-center'>
              ...
              <Link to='/services' className='text-black hover:underline pl-4'>
                Product Management
              </Link>
            </li>
          </ul>
