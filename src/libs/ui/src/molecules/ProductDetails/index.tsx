...
const ProductDetails: React.FC<ProductDetailsprops> = ({
  ...
  const [visibleParagraph, setVisibleParagraph] = useState<
    'How to Apply' | 'Regimen Information'
  >('How to Apply');
    ...
    <div className='pt-[37px] pb-[64px]'>
      ...
      <div className='hidden lg:grid grid-cols-4 gap-[9rem] '>
        <div className='col-span-1 flex flex-col w-[236px] h-[136px]'>
          <BusinessSidebar
            categories={ProductDescription.ProductDescription.map(
              (category) => ({
          ...
          {visibleParagraph === 'Regimen Information' && (
            <Paragraph className='font-HeroNewLight text-darkGray'>
              ...
              <ol className='list-decimal ml-[40px]'>
                <li>Cleanse</li>
                <li>
                  <span className='font-HeroNewBold'>
                    {' '}
                    {regimenInfromation}
                  </span>
                </li>
      ...
      <div className='lg:hidden p-[10px]'>
        <AccordionItem
          ...
          titleClassName={
            activeTitle === 'How to Apply'
              ? 'text-appTheme text-[20px] font-HeroNewExtraBold '
              : 'text-[20px] text-[#555555] 2xs:pb-[32px] font-HeroNewExtraBold'
          }
          title='How to Apply'
        ...
        <AccordionItem
          ...
          accordianStatus={handleAccordionStatus}
          titleClassName={
            activeTitle === 'Regimen Information'
              ? 'text-appTheme text-[20px] font-HeroNewExtraBold'
              : 'text-[20px] text-[#555555] 2xs:pb-[32px]  font-HeroNewExtraBold'
          }
        ...
        >
          <Paragraph className='font-HeroNewLight text-darkGray'>
            ...
            <ol className='list-decimal ml-[40px]'>
              <li>Cleanse</li>
              <li>
                <span className='font-HeroNewBold'> {regimenInfromation}</span>
              </li>
              <li>Hydrate</li>
              <li>Protect</li>
            </ol>
