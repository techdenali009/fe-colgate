...
export const FilterBadge: React.FC<FilterBadgeProps> = ({ children, onRemove }) => {
  return (
    ...
    >
      <span className="text-blue-700 hover:font-bold  text-xs mr-1">{children}</span>
      <button
        onClick={onRemove}
        className="ml-2 bg-transparent p-0 border-none text-blue-500 hover:text-blue-700 hover:font-bold"
