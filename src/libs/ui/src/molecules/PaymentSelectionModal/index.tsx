...
//   useEffect(() => {
//     console.log('User addresses:', formattedAddresses);
//   }, [formattedAddresses]);
...
//       console.log('orderIdssssssssss',totalAmount);
...
//             </p>
//             <div className="mt-4">
//               <h3 className="text-lg font-bold mb-2">Your Addresses:</h3>
//               {formattedAddresses.map((address: { street: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined; city: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined; postalCode: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined; country: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined; }, index: React.Key | null | undefined) => (
...
//             totalAmount={orderData?.data?.order?.totalCartPrice || ''}
//           />
//         )
//       )}
