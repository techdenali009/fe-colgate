...
export const ButtonWithTextAndIcon: React.FC<ButtonWithTextAndIconProps> = ({
  ...
  return (
    <Button
      onClick={onClick}
      className={`bg-white border border-appTheme text-appTheme p-2 m-1 transition-all duration-300 hover:bg-black hover:underline hover:text-white hover:border-black ${className}`}
