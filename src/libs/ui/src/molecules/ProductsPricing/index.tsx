  ...
  return (
    <div className="mb-10">
      ...
      <div className="items-center">
        ...
        >
          <div>
            <p>Only daily care products are available for all customers. You must be a PCA SKIN Certified Professional to order professional products.</p>
        ...
        >
          <div>
            <p>PCA SKIN offers several physician-only peels, including Ultra Peel Forte®, 6% Pure Retinol Peel, and Intensive Pigment Eraser. These peels are exclusively available for purchase by medical providers such as medical doctors, nurse practitioners, or physician assistants.</p>
        ...
        >
          <div>
            <p>Contact a <strong className="font-bold font-HeroNewBold">PCA SKIN®</strong>  Customer Service Representatives at 877.PCA.SKIN [877.722.7546]</p>
