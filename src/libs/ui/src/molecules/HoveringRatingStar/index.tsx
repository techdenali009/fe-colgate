...
const HoverStarRating: React.FC<StarRatingProps> = ({ totalStars = 5, initialRating = 0 }) => {
  ...
  return (
    <div>
      <h3 className="text-lg font-SansSerif mb-4 ">Review this Product</h3>
      <div className="flex">
        {Array.from({ length: totalStars }, (_, index) => {
          ...
          return (
            <span
              key={index}
              className={`cursor-pointer transition-colors p-2 mx-1 border-[1px] rounded-lg w-[59px] h-[59px] flex justify-center ${isFilled
      ...
      <p className="mt-4 text-[18px] text-gray-600  font-SansSerif">
