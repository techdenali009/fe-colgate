            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border py-2 z-50">
                  ...
                  <div>
                    <button className="group w-full px-4 py-2 text-sm hover:bg-appTheme transition-colors flex items-center gap-3 hover:text-white" onClick={()=>{navigate('MyProfile')}}>
                      <UserCircle className=" text-gray-500 transition-colors group-hover:text-white"></UserCircle>
                      My Profile
                    </button>
                  </div>
                  <div>
                    <button className="group w-full px-4 py-2 text-sm hover:bg-appTheme transition-colors flex items-center gap-3 hover:text-white" onClick={()=>{navigate('ChangePassword')}}>
                      <KeyRound className=" text-gray-500 transition-colors group-hover:text-white"></KeyRound>
                      Change Password
                    </button>
                  </div>
                  <div>
                    <button
                      className="group w-full px-4 py-2 text-sm hover:bg-appTheme transition-colors flex items-center gap-3 hover:text-white"
                      onClick={handelLogout}
                    >
                      <LogOut className=" text-gray-500 transition-colors group-hover:text-white"></LogOut>
                      Logout
                    </button>
                  </div>
                </div>
